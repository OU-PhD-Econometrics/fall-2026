...
\author{University of Oklahoma\\ Fall 2026}
\date{}
...
\begin{enumerate}
    %\item Subscription to a frontier ``Generative AI'' Large Language Model (such as ChatGPT, Claude, or Gemini)---this costs \$20/month and will be used continuously throughout the course. As of August 2026, I recommend Claude, which is available at \url{https://claude.ai/}.
...
Most course materials will also be publicly posted on GitHub at \url{https://github.com/OU-PhD-Econometrics/fall-2026}.
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Simulated data description, parameter values used, and \textit{either} estimation validation results \textit{or} theoretical validation of calibrated parameters
...
The University of Oklahoma (OU) is committed to the goal of achieving equal educational opportunity and full educational participation for students with disabilities. If you have already established reasonable accommodations with the Accessibility and Disability Resource Center (ADRC), please log into AIM to request your semester accommodations as soon as possible and contact me privately, so that we have adequate time to arrange your approved academic accommodations.
...
The schedule below gives the approximate dates for all topics and graded assignments. It is also posted at \url{https://github.com/OU-PhD-Econometrics/fall-2026/blob/master/README.md}, where it will be updated regularly along with links to all slides, videos, and problem sets; please check there for the most recent version.

\begin{landscape}
\section*{Class Schedule, Page 1}
\begin{center}
\begin{tabular}{cc>{\raggedright}m{5.5cm}>{\raggedright}m{7.5cm}>{\raggedright}m{3.5cm}}
\toprule
\textbf{Class} & \textbf{Date} & \textbf{In-class coding activity} & \textbf{Pre-class work and materials} & \textbf{Items due} \tabularnewline \midrule
1  & Tue Aug 25 & Course intro; productivity and computational tools & Slides: Julia reference                                                            &  \tabularnewline
2  & Thu Aug 27 & Working with Julia code (PS 1)                      & Quiz; Clean Coding videos 1--5                                                     &  \tabularnewline
3  & Tue Sep 1  & Working with Julia code (PS 1)                      & Quiz                                                     &  \tabularnewline
4  & Thu Sep 3  & Structural modeling process                         & Quiz; Structural Econometrics Spectrum videos; Lewbel (2019) Sec. 1, 5, 5.1        &  \tabularnewline
5  & Tue Sep 8  & Structural modeling process                         & Quiz; Structural Modeling Process videos; Keane YouTube talk                       &  \tabularnewline
6  & Thu Sep 10 & Static discrete choice modeling (PS 2)              & Quiz; Static Discrete Choice videos 1--4; \emph{Train} Ch. 1--2, 3.1--3.3, 3.7--3.8 &  \tabularnewline
7  & Tue Sep 15 & Static discrete choice modeling (PS 2)              & Quiz; Static Discrete Choice videos 5--8; \emph{Train} Ch. 1--2, 3.1--3.3, 3.7--3.8 &  \tabularnewline
8  & Thu Sep 17 & Nested logit choice modeling (PS 3)                 & Quiz; GEV videos 1--4; \emph{Train} 4.1--4.2                                       &  \tabularnewline
9  & Tue Sep 22 & Nested logit choice modeling (PS 3)                 & Quiz; GEV videos 5--7; \emph{Train} 4.1--4.2                                       &  \tabularnewline
10 & Thu Sep 24 & Mixed logit choice modeling (PS 4)                  & Quiz; Mixed Logit videos 1--4; \emph{Train} 6.1--6.3, Ch. 14                       &  \tabularnewline
11 & Tue Sep 29 & Mixed logit choice modeling (PS 4)                  & Quiz; Mixed Logit videos 5--8; \emph{Train} 6.1--6.3, Ch. 14                       &  \tabularnewline
12 & Thu Oct 1  & Dynamic discrete choice modeling (PS 5)             & Quiz; Dynamic Discrete Choice videos 1--4; Rust (1987)                             &  \tabularnewline
13 & Tue Oct 6  & Dynamic discrete choice modeling (PS 5)             & Quiz; Dynamic Discrete Choice videos 5--8; Rust (1987)                             &  \tabularnewline
14 & Thu Oct 8  & Conditional choice probabilities (PS 6)             & Quiz; CCP videos 1--4; Hotz and Miller (1993); Arcidiacono and Miller (2011)       &  \tabularnewline
15 & Tue Oct 13 & Conditional choice probabilities (PS 6)             & Quiz; CCP videos 5--8; Hotz and Miller (1993); Arcidiacono and Miller (2011)       &  \tabularnewline
16 & Thu Oct 15 & Simulation-based estimation methods (PS 7)          & Quiz; Simulation-Based Estimation videos 1--4; \emph{Train} 10.1--10.2; Smith, p. 1 &  \tabularnewline
\bottomrule
\end{tabular}
\par\end{center}
\end{landscape}
...
\begin{landscape}
\section*{Class Schedule, Page 2}
\begin{center}
\begin{tabular}{cc>{\raggedright}m{5.5cm}>{\raggedright}m{7.5cm}>{\raggedright}m{3.5cm}}
\toprule
\textbf{Class} & \textbf{Date} & \textbf{In-class coding activity} & \textbf{Pre-class work and materials} & \textbf{Items due} \tabularnewline \midrule
17  & Tue Oct 20 & Simulation-based estimation methods (PS 7)          & Quiz; Simulation-Based Estimation videos 5--8; \emph{Train} 10.1--10.2; Smith, p. 1 &  \tabularnewline
18  & Thu Oct 22 & Running counterfactuals                                        & Quiz; Model Fit, Validation, and Counterfactuals videos; Fu, Grau and Rivera (2022); Lang and Palacios (2018) &  \tabularnewline
19  & Tue Oct 27 & Estimating preferences from choice-experimental data           & Quiz; Stated Preference videos; \emph{Train} 7.2--7.3; Ko\c{s}ar, Ransom and van der Klaauw (2026) Sec. 3.3   &  \tabularnewline
20  & Thu Oct 29 & Measurement error and factor models (PS 8)                     & Quiz; Measurement Error videos 1--4; Heckman, Stixrud and Urzua (2006)                                        &  \tabularnewline
21  & Tue Nov 3  & Measurement error and factor models (PS 8)                     & Quiz; Measurement Error videos 5--8; Heckman, Stixrud and Urzua (2006)                                        &  \tabularnewline
22  & Thu Nov 5  & Learning models                                                & Quiz; Learning Models videos; Miller (1984)                                                                   &  \tabularnewline
23  & Tue Nov 10 & \textbf{Midterm Exam (in-class)}                               & Review study guide                                                                                           & \textbf{Midterm exam} \tabularnewline
24  & Thu Nov 12 & How to do a referee report                                     & Quiz on advanced optimization; Advanced Optimization videos                                                   & Start finding a paper for presentation / referee report \tabularnewline
25  & Tue Nov 17 & Demonstration for final project                                & Quiz on extreme value theory; Extreme Value Theory videos                                                     &  \tabularnewline
26  & Thu Nov 19 & Relative correlation restrictions to bound causal effect sizes & Quiz; Sensitivity Analysis and Partial Identification videos; Altonji, Elder and Taber (2005); Diegert, Masten and Poirier (2026) &  \tabularnewline
--- & Tue Nov 24 & \textbf{No class} (work on your structural modeling exercise)  & \textbf{No class}                                                                                            &  \tabularnewline
--- & Thu Nov 26 & \textbf{No class} (Thanksgiving)                               & \textbf{No class}                                                                                            &  \tabularnewline
\bottomrule
\end{tabular}
\par\end{center}
\end{landscape}
...
\begin{landscape}
\section*{Class Schedule, Page 3}
\begin{center}
\begin{tabular}{cc>{\raggedright}m{5.5cm}>{\raggedright}m{7.5cm}>{\raggedright}m{3.5cm}}
\toprule
\textbf{Class} & \textbf{Date} & \textbf{In-class coding activity} & \textbf{Pre-class work and materials} & \textbf{Items due} \tabularnewline \midrule
27  & Tue Dec 1  & Machine learning               & Quiz; Machine Learning and Econometrics videos 1--4; James et al. (2023) Sec. 2.1 (pp. 15--29) &  \tabularnewline
28  & Thu Dec 3  & Machine learning               & Quiz; Machine Learning and Econometrics videos 5--9                                           & Work on referee report and presentation \tabularnewline
29  & Tue Dec 8  & Presentations                  &                                                                                               & \textbf{Presentation} \tabularnewline
30  & Thu Dec 10 & Presentations                  &                                                                                               & \textbf{Presentation; referee report due} (submit to Canvas) \tabularnewline
--- & Mon Dec 14 & \textbf{No in-class final exam} &                                                                                              &  \tabularnewline
--- & Wed Dec 16 &                                &                                                                                               & \textbf{Structural Modeling Exercise due} (submit to Canvas) \tabularnewline
\bottomrule
\end{tabular}
\par\end{center}
\end{landscape}
