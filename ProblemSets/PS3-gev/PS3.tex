...
On Github there is a file called \texttt{PS3starter.jl} that has the code blocks below already created.
...
using CSV
using HTTP
url = "https://raw.githubusercontent.com/OU-PhD-Econometrics/fall-2026/
