...
All slides will be available on the [course GitHub page](https://github.com/OU-PhD-Econometrics/fall-2026)
...
- There is a [separate slide deck](https://raw.githack.com/OU-PhD-Econometrics/fall-2026/master/LectureNotes/00-JuliaTips/00slides.html#1) for your reference
...
- After signing up for a GitHub account, go to the class [repository](https://github.com/OU-PhD-Econometrics/fall-2026) and click `Fork` in the top-righthand corner

- Once you do this, you should be able to visit https://github.com/your-username/fall-2026 and see an exact copy of all of the files

- You can also rename your fork if the default name of "fall-2026" is not to your liking
